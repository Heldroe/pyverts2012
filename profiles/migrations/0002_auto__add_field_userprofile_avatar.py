...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_userprofile', 'avatar',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profiles_userprofile', 'avatar')
    ...
    models = {
        ...
        'profiles.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'test': ('django.db.models.fields.CharField', [], {'default': "'Dragons.'", 'max_length': '20'}),
