...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Element.db_img'
        db.alter_column('elements_element', 'db_img', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Element.db_img'
        db.alter_column('elements_element', 'db_img', self.gf('django.db.models.fields.CharField')(max_length=2000))
    ...
    models = {
        ...
        'elements.element': {
            ...
            'db_img': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2000', 'null': 'True', 'blank': 'True'}),
