...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Element.original_avatar'
        db.delete_column('elements_element', 'original_avatar')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Element.original_avatar'
        raise RuntimeError("Cannot reverse this migration. 'Element.original_avatar' and its values cannot be restored.")
