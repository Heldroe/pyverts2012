...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Element.db_id'
        db.add_column('elements_element', 'db_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Element.db_img'
        db.add_column('elements_element', 'db_img',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000, blank=True),
                      keep_default=False)

        # Adding field 'Element.latitude'
        db.add_column('elements_element', 'latitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Element.longitude'
        db.add_column('elements_element', 'longitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Element.db_id'
        db.delete_column('elements_element', 'db_id')

        # Deleting field 'Element.db_img'
        db.delete_column('elements_element', 'db_img')

        # Deleting field 'Element.latitude'
        db.delete_column('elements_element', 'latitude')

        # Deleting field 'Element.longitude'
        db.delete_column('elements_element', 'longitude')
    ...
    models = {
        ...
        'elements.element': {
            ...
            'db_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'db_img': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2000', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'longitude': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
