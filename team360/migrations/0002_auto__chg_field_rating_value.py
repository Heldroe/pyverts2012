...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('team360_rating', 'value', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Rating.value'
        raise RuntimeError("Cannot reverse this migration. 'Rating.value' and its values cannot be restored.")
